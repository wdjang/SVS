...
for e = 1 : numel(contours.edge_x_coords)
    ...
    for p = 1 : numel(contours.edge_x_coords{e}),
        ws_wt(contours.edge_x_coords{e}(p), contours.edge_y_coords{e}(p)) = ...
            max(pb_oriented(contours.edge_x_coords{e}(p), contours.edge_y_coords{e}(p)), ws_wt(contours.edge_x_coords{e}(p), contours.edge_y_coords{e}(p)));
%             max(max(pb_oriented(contours.edge_x_coords{e}(p), contours.edge_y_coords{e}(p), :)), ws_wt(contours.edge_x_coords{e}(p), contours.edge_y_coords{e}(p)));
%             max(pb_oriented(contours.edge_x_coords{e}(p), contours.edge_y_coords{e}(p), orient(e)), ws_wt(contours.edge_x_coords{e}(p), contours.edge_y_coords{e}(p)));
    ...
    v1=contours.vertices(contours.edges(e,1),:);
    v2=contours.vertices(contours.edges(e,2),:);
    ws_wt(v1(1),v1(2))=max( pb_oriented(v1(1),v1(2)),ws_wt(v1(1),v1(2)));
%     ws_wt(v1(1),v1(2))=max( max(pb_oriented(v1(1),v1(2),:)),ws_wt(v1(1),v1(2)));
%     ws_wt(v1(1),v1(2))=max( pb_oriented(v1(1),v1(2), orient(e)),ws_wt(v1(1),v1(2)));
    ws_wt(v2(1),v2(2))=max( pb_oriented(v2(1),v2(2)),ws_wt(v2(1),v2(2)));
%     ws_wt(v2(1),v2(2))=max( max(pb_oriented(v2(1),v2(2),:)),ws_wt(v2(1),v2(2)));
